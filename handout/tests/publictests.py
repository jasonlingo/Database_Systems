...
class Hw0PublicTests(unittest.TestCase):
  ...
  def testReadCSV(self):
    # Orders
    orders_lst = readCsvFile('/Users/Jason/Dropbox/Courses/600.416 Database Systems/Assignments/datasets/hw0/tpch-sf0.1/orders.csv', Orders)
    for (i, order) in enumerate(orders_lst[0:5]):
      self.assertEqual(order.o_orderkey, i+1, 'Failed to read orders object from csv')
   
    # Lineitem 
    lineitem_lst = readCsvFile('/Users/Jason/Dropbox/Courses/600.416 Database Systems/Assignments/datasets/hw0/tpch-sf0.1/lineitem.csv', Lineitem)
  ...
  def testBinary(self):
    ...
    orders_lst1 = readCsvFile('/Users/Jason/Dropbox/Courses/600.416 Database Systems/Assignments/datasets/hw0/tpch-sf0.1/orders.csv', Orders)[0:5]
